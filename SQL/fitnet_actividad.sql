...
CREATE TABLE `actividad` (
  ...
  PRIMARY KEY (`id`),
  KEY `actividad_bitacora_idx` (`id_bitacora`),
  CONSTRAINT `actividad_bitacora` FOREIGN KEY (`id_bitacora`) REFERENCES `bitacora` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
