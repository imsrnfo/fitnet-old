...
CREATE TABLE `cliente` (
  ...
  PRIMARY KEY (`id`),
  KEY `cliente_bitacora_idx` (`id_bitacora`),
  CONSTRAINT `cliente_bitacora` FOREIGN KEY (`id_bitacora`) REFERENCES `bitacora` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
